...
const initialProjects: Project[] = [
  ...
  },
  {
    ...
    status: 'Published',
    description: 'A small visual playground where students turn everyday observations into interactive signals and soft experiments.',
    tags: ['Interactive', 'Visual design', 'Prototype'],
    accent: 'violet',
    updated: 'This week',
    views: '—',
    features: ['Interactive stories', 'Motion studies', 'Project notes', 'Responsive canvas'],
    demoUrl: '',
  },
  {
    id: '06',
    ...
    category: 'Culture + code',
    status: 'Published',
    description: 'A digital atlas of ordinary places, objects, and rituals that make student life in Tashkent feel specific.',
    tags: ['Editorial', 'Culture', 'Research'],
    accent: 'blue',
    updated: 'This week',
    views: '—',
    features: ['Place cards', 'Field notes', 'Open archive', 'Multilingual labels'],
    demoUrl: '',
  },
  {
    id: '07',
    ...
    category: 'Learning systems',
    status: 'Draft',
    description: 'A lightweight study exchange for sharing useful explanations, examples, and the questions that remain open.',
    tags: ['Education', 'Community', 'Prototype'],
    accent: 'green',
    updated: 'This week',
    views: '—',
    features: ['Question threads', 'Saved explanations', 'Topic filters', 'Creator profiles'],
    demoUrl: '',
  },
  {
    id: '08',
    title: 'Perkly',
    owner: 'Mukarramov Shoxruxbek',
    category: 'Web & Mobile',
    status: 'Published',
    description: 'Perkly помогает сделать условия понятными до покупки и связать каталог, продавца и мобильный клиент в один опыт.',
    tags: ['Marketplace', 'Web + Mobile', 'Full-Stack'],
    accent: 'violet',
    updated: '2026',
    views: '—',
    features: ['Условия до оплаты', 'Две стороны рынка', 'QR и промокоды', 'Общая кодовая база'],
    demoUrl: 'https://perkly.uz',
  },
  {
    id: '09',
    title: 'ISHONCH',
    ...
    status: 'Published',
    description: 'ISHONCH превращает большой ассортимент и сложные условия рассрочки в быстрый промо-сценарий — от первого оффера до заявки в CRM.',
    tags: ['Retail', 'Web', 'UZ / RU'],
    accent: 'orange',
    updated: '2025',
    views: '—',
    features: ['Калькулятор рассрочки', 'Скорость как фича', 'Заявки в CRM', 'Две локали'],
    demoUrl: 'https://ishonch.95-130-227-217.nip.io/',
  },
  {
    id: '10',
    title: 'Ассоциация киберспорта',
    owner: 'Mukarramov Shoxruxbek',
    category: 'Sports portal',
    status: 'Published',
    description: 'Портал федерации связывает соревнования, игроков и зрителей в одном цифровом пространстве — от анонса события до результата матча.',
    tags: ['Sports', 'Portal', 'AI'],
    accent: 'blue',
    updated: '2025 — н.в.',
    views: '—',
    features: ['Киберпаспорт игрока', 'Сетки в реальном времени', 'AI-ассистент ESPI', 'Секция FPV-дронов'],
    demoUrl: 'https://cybersport.95-130-227-217.nip.io',
  },
];
...
const projectCoverFallbacks: Record<string, string> = {
  ...
  '05': '/projects/nihongo-talk-trainer.jpg',
  '06': '/projects/jdu-open-archive.jpg',
  '07': '/projects/quiet-city-index.jpg',
  '08': '/projects/osh-table.jpg',
  '09': '/projects/quiet-city-index.jpg',
  '10': '/projects/jdu-open-archive.jpg',
};
